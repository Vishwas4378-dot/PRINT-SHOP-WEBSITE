...
const Order = require('G:/print-shop/print-backend/models/Order.js');
const User = require('G:/print-shop/print-backend/models/User.js');
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const order = await Order.create({ owner: userId, products: cart, country, address });
