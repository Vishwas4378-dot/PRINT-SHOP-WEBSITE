...
import "G:/print-shop/src/pages/Cartpage.css";

const stripePromise = loadStripe("pk_test_51MklhDSIQDCznLldemQIMdHg8vsTVO5G3uwQsynUZBsaimQ5h2NuZ3qMtcLv0BjskYMZUCIEbSVJb5tyqq0fELFg00tN1H3MHk");
        ...
        <Container style={{ minHeight: "95vh" }} className="cart-container">
            <Row>
                <Col>
                    ...
                    {cart.length == 0 ? (
                        <Alert variant="info">Payment successful. Shopping cart is empty. Add products to your cart</Alert>
                    ) : (
